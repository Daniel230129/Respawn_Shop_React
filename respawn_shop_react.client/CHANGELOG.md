...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest respawn_shop_react.client -- --template=react  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`respawn_shop_react.client.esproj`).
